      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-200">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="bg-emerald-50 text-emerald-900 border border-emerald-200 px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold flex items-center gap-1">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 active:scale-[0.99] text-white text-xs font-bold transition-all shadow-xs flex items-center gap-1.5 self-start sm:self-auto"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-1.5">
          ...
          <div className="text-[11px] font-mono text-slate-500">
            Across online bags & Mysuru showroom POS
          </div>
        </div>

        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-1.5">
          <div className="flex items-center justify-between text-slate-500 text-xs font-mono">
            <span>Active Campaign Ratio</span>
            <Sparkles className="w-4 h-4 text-amber-500" />
          </div>
          <div className="text-2xl font-bold font-mono text-slate-900 tracking-tight">
            {summary.activeCount} / {coupons.length} Active
          </div>
          <div className="text-[11px] font-mono text-slate-500">
            {coupons.filter((c) => c.status === 'SCHEDULED').length} Scheduled for upcoming festivals
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              type="text"
              placeholder="Search by Coupon Code, Title, or Offer Details..."
              value={searchQuery}
