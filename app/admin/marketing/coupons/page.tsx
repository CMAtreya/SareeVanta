      ...
      .then((data) => {
        if (data.coupons && Array.isArray(data.coupons)) {
          const formatted: CouponItem[] = data.coupons.map((c: any) => ({
            id: c.id,
            code: c.code,
            title: c.title || `Privilege Promo ${c.code}`,
            ...
            limitPerCustomer: Number(c.limit_per_customer || 1),
            ...
            applicableWeaves: Array.isArray(c.applicable_weaves) ? c.applicable_weaves : ['ALL'],
            excludedWeaves: Array.isArray(c.excluded_weaves) ? c.excluded_weaves : [],
          }));
